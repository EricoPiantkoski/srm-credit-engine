...
4. Você é expressamente proibido de dar qualquer comando git cujo objetivo seja diferente de uma simples consulta. Comandos como git pull, add, rebase, merge, dentre outros NUNCA devem ser dados sem a expressa permissão. Se você achar necessário utilizá-los, não os use, informe ao usuário e ele deve decidir
...
1. DELEGAÇÃO DE AGENTE (MUDANÇA DE CONTEXTO):
