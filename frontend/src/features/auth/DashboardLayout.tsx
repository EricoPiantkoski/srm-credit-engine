...
const NAV_ITEMS = [
  ...
  { to: '/liquidacoes', label: 'Liquidação', path: 'M5 3h14a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1z M9 8h6 M9 12h6 M9 16h3' },
  { to: '/extrato', label: 'Extrato', path: 'M6 2h9l5 5v15a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z M14 2v6h6 M9 13h6 M9 17h6' },
]
